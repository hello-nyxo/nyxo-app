...
export default function getStateFromPath(
  ...
  if (query) {
    ...
    if (linkArray[0] === 'link' || (linkArray[0] === '/link' && linkArray[1])) {
      const customParams = { link: linkArray[1] }
      route.params = { ...route.params, ...customParams }
    } else {
...
// if (linkArray[0] === "link" && linkArray[1]) {
//   const customParams = { link: linkArray[1] };
//   route.params = { ...route.params, ...customParams };
// } else {
//   route.params = { ...route.params, ...params };
